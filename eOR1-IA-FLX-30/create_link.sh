...
cd ${dirout}/FORCINGS_TEST_Srinivas_nofresh

yr=${YearBegin}
while [ ${yr} -le ${YearEnd} ] ; do
  #clm
  ln -sf ${dirout}/FORCINGS/clm_1980-2018/${JobName}_clim1980-2018_3H_SBC.nc                          hflux_${yr}.nc
  ln -sf ${dirout}/FORCINGS/clm_1980-2018/${JobName}_clim1980-2018_3H_SBC.nc                          fflux_${yr}.nc

  #ano
  ln -sf ${dirout}/FORCINGS/ano_subtract_ANL/${JobName}_${yr}0101_${yr}1231_ano-ANL_1M_grid_U.nc      utau_ano_${yr}.nc
  ln -sf ${dirout}/FORCINGS/ano_subtract_ANL/${JobName}_${yr}0101_${yr}1231_ano-ANL_1M_grid_V.nc      vtau_ano_${yr}.nc
...
ln -sf ${dirout}/FORCINGS/clm_1980-2018/${JobName}_clim1980-2018_3H_SBC.nc                                         fflux_${YearFirst}.nc
ln -sf ${dirout}/FORCINGS/ano_subtract_ANL/${JobName}_${YearBegin}0101_${YearBegin}1231_ano-ANL_1M_grid_U.nc       utau_ano_${YearFirst}.nc
ln -sf ${dirout}/FORCINGS/ano_subtract_ANL/${JobName}_${YearBegin}0101_${YearBegin}1231_ano-ANL_1M_grid_V.nc       vtau_ano_${YearFirst}.nc
...
ln -sf ${dirout}/FORCINGS/clm_1980-2018/${JobName}_clim1980-2018_3H_SBC.nc                                         fflux_${YearLast}.nc
ln -sf ${dirout}/FORCINGS/ano_subtract_ANL/${JobName}_${YearEnd}0101_${YearEnd}1231_ano-ANL_1M_grid_U.nc           utau_ano_${YearLast}.nc
ln -sf ${dirout}/FORCINGS/ano_subtract_ANL/${JobName}_${YearEnd}0101_${YearEnd}1231_ano-ANL_1M_grid_V.nc           vtau_ano_${YearLast}.nc
